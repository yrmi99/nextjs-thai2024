  ...
  return (
    ...
    <div className="backdrop-blur-lg bg-white dark:bg-transparent dark:bg-opacity-20 dark:text-white last:border-b max-w-screen-lg w-80% p-5 m-auto border border-[#B3A369] flex flex-col">
      ...
      <div className="mt-2">
        ...
        <span>먼저, 기도편지를 읽으러 와주셔서 진심으로 감사하다는 말씀을 전합니다. 하나님의 인도하심인 만큼, 읽으시는 동안 하나님께서 
        마음의 감동을 주시길 소망합니다. 
        제가 이 기도편지를 쓰게 된 이유는, 작년에 이어 다가오는 6월 한 달을 선교로 주님께 드리기로 결정하였기 때문입니다. 
        주님의 사역을 이루기 위해선 많은 동역자 분들의 기도와 후원이 필요합니다!</span>
      </div>

      <div className="mt-2">
        <span className="font-bold">장소</span><br></br>
        <span>제가 가게 될 지역은 태국의 우돈타니라는 지방의 작은 도시입니다. 
          많은 분들이 아시다시피, 태국은 거의 모든 국민이 불교를 믿으며, 기독교인은 단 1%도 차지하지 않는 나라입니다. 
          최근에는 마약의 노출과 성에 대한 잘못된 인식이 청년부터 어린 학생들의 문화까지 크게 압도하고 있는 상황입니다.
          특히 우돈타니가 위치한 이싼 지방은 인신매매율이 높고 환경이 좋지 않아 선교지로서도 아직까지 많은 관심이 필요한 지역입니다.
        </span>
      </div>

      <div className="mt-2">
        <span className="font-bold">방법</span><br></br>
        <span>저와 저와 함께가는 캠퍼스 선교 단체 &apos;SOON Global Movement(ICCC 산하조직)&apos; 친구들은
            라자밧 대학교에서 신입생을 대상으로 영어 학교를 운영하며 전도할 예정입니다. 2주간 서로에 대해 알아간 후,
            3주차에는 작년에 학생들의 큰 호응을 불러일으켰던 무언극과 찬양, 케이팝 무대 등을 선보여
            &apos;Friend’s Night&apos;이라는 전도 집회를 열 계획입니다.</span>
      </div>

      <div className="mt-2">
        <span className="font-bold">목적</span><br></br>
        <span>지난 번 선교는 제게 작년 가장 행복한 한 달이었다 해도 과언이 아닐 정도로 은혜와 기쁨이 넘치는 시간이었습니다.
            그 중 가장 큰 선물은 영어 수업에서 만난, 마치 친동생과도 같은 학생들이었습니다. 언어장벽에도 불구하고 낯선 저를 친언니처럼
            따라준 그 친구들은 선교가 끝난 지금까지도 서로의 안부를 묻는 귀한 친구가 되었습니다.
            몇 달간 선교를 놓고 하나님의 인도 하심을 구한 결과, 하나님께서는 여러 사람들의 입을 통하여서 제게 태국으로 마음과 기회의 문을 열어주셨습니다.
